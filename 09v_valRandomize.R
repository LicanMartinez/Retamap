...
#   Written to gee_scripts/ (NOT the gitignored WORK_DIR): the App needs it in
#   the GEE repo. Contains only pxids (no labels) → safe to publish.
assign_js <- file.path(dirname(WORK_DIR), "09v_valAssign.js")
assign_lines <- c(
  "// =============================================================================",
